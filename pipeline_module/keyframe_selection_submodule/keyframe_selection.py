import csv
from ..utils_module.utils import load_progress_from_file, read_value_from_file, return_video_frames_folder, \
    return_video_folder_name, save_progress_to_file, save_value_to_file
        ...
        with open(outcsvpath, 'w', newline='', encoding='utf-8') as outcsvfile:
            ...
            for frame_index in keyframes:
                ...
                self.video_runner_obj["logger"].info(
                    f"Frame Index: {frame_index} Timestamp: {float(frame_index) * seconds_per_frame}")
